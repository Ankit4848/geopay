        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              bool isValid =
              await bankTransferController.getPassword(passCtrl.text);
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Obx(
                      () => Visibility(
                        visible: bankTransferController.selectedCountry.value !=
                            null,
                        child: CustomTextField(
                          ...
                          errorWidget: bankTransferController.beneError.value!=""?
                          Text(bankTransferController.beneError.value,
                              style: TextStyle(
                                  color: Colors.red,
                                  fontSize: 12
                              )):Offstage(),
                          hintText: bankTransferController.selectedBene.value ==
                                  null
                              ? 'Select Recipient'
                    ...
                    CustomTextField(
                      ...
                      errorWidget: bankTransferController.amountError.value!=""?
                      Text(bankTransferController.amountError.value,
                          style: TextStyle(
                              color: Colors.red,
                              fontSize: 12
                          )):Offstage(),
                      ...
                      onChange: (value) async {
                        if(value!.isNotEmpty) {
                          await bankTransferController.fetchAmountBreakdown();
                        }else
                          {
                            bankTransferController.commissionModel.value = null;
                          }
                        setState(() {});
                      },
                      // prefixIcon: Padding(
                    ...
                    if (bankTransferController.commissionModel.value != null)
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildAmountInfo(
                              ...
                              bankTransferController
                                  .commissionModel.value!.payoutCurrencyAmount!
                                  .toStringAsFixed(2),
                            ),
                          ],
                        ),
                    ...
                    Stack(
                      children: [
                        CustomTextField(
                          controller:
                              bankTransferController.accountDescriptionCtrl,
          ...
          Container(
            ...
            child: CustomFlatButton(
              onPressed: () async {
                ...
                bool hasError = false;
                if (bankTransferController.selectedCountry.value == null) {
                  bankTransferController.countryError.value = 'Country is required.';
                  hasError = true;
                }
                if (bankTransferController.selectedBene.value == null) {
                  bankTransferController.beneError.value = 'Beneficiary is required.';
                  hasError = true;
                }
                if (bankTransferController.amountCtrl.text.trim().isEmpty) {
                  bankTransferController.amountError.value = 'Amount is required.';
                  hasError = true;
                }
                setState(() {
