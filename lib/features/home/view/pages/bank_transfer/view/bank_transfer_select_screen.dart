...
class _BankTransferSelectScreenState extends State<BankTransferSelectScreen> {
  ...
  void initState() {
    ...
    bankTransferController.getTMtoMBeneListStore();
  }
  ...
  String getCountryFlag(String payoutCountry) {
    try {
      var country = bankTransferController.countryCollectionList.firstWhere(
        (country) => country.data == payoutCountry,
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          CustomAppBar(title: 'Transfer to Bank Account’s'),
          Expanded(
                      ...
                      children: [
                        Expanded(
                          child: MaterialButton(
                            ...
                            onPressed: () {
                              Get.to(
                                AddBankBeneficiaryScreen(isEdit: false),
                              )?.then((v) async {
                          ...
                          : Container(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                var data =
                                    bankTransferController
                                        .mobileBeneficiaryRecentList[index]
                                        .data;
                                ...
                                return GestureDetector(
                                  onTap: () async {
                                    ...
                                    if (selectedCountryFromList != null) {
                                      ...
                                      var selectedBeneFromList =
                                          bankTransferController
                                              .mobileBeneficiaryList
                                              .where(
                                                (bene) =>
                                                    bene.data["bankaccountnumber"] ==
